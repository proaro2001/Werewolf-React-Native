export default {
  ...
  witch: {
    name: "witch",
    image: require("../assets/cards/witch.jpg"),
    description: "You can save or kill one player every night.",
  },
  hunter: {
    name: "hunter",
  ...
  idiot: {
    ...
    description: "You can survive one execution.",
  },
  knight: {
    name: "knight",
    image: require("../assets/cards/knight.jpg"),
    description:
